...
export const isKnowledgeFileItem = (
	item: KnowledgeItem,
): item is KnowledgeFileItem => {
...
export const isKnowledgeVideoItem = (
	item: KnowledgeItem,
): item is KnowledgeVideoItem => {
...
export const isKnowledgeNoteItem = (
	item: KnowledgeItem,
): item is KnowledgeNoteItem => {
...
export const isKnowledgeDirectoryItem = (
	item: KnowledgeItem,
): item is KnowledgeDirectoryItem => {
...
export const isKnowledgeUrlItem = (
	item: KnowledgeItem,
): item is KnowledgeUrlItem => {
...
export const isKnowledgeSitemapItem = (
	item: KnowledgeItem,
): item is KnowledgeSitemapItem => {
...
export const isPreprocessProviderId = (
	id: string,
): id is PreprocessProviderId => {
