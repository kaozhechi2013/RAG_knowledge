...
export const SYSTEM_MODELS: Record<SystemProviderId | "defaultModel", Model[]> =
	{
		defaultModel: [
			// Default assistant model - 使用本地 Qwen3
			localQwen3Model,
			// Default topic naming model - 使用本地 Qwen3
			localQwen3Model,
			// Default translation model - 使用本地 Qwen3
			localQwen3Model,
			// Default quick assistant model - 使用本地 Qwen3
			localQwen3Model,
		],
		cherryin: [localQwen3Model],
		vertexai: [],
		"302ai": [
			{
				id: "deepseek-chat",
