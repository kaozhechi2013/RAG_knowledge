...
const DEFAULT_ACCESS_STATE = {
	accessCode: "",
	useCustomConfig: true, // Enable custom config by default

	provider: ServiceProvider.OpenAI,

	// openai - pointing to our Knowledge API server
	openaiUrl: "http://10.216.186.24:8080",
	openaiApiKey: "sk-knowledge-internal-2024", // Fixed API Key matching Knowledge server
